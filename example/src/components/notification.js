...
import { TitleBarThemeContext, TitleBarButton } from '@cafercangundogdu/frameless-titlebar'
  ...
  return (
    <div style={{ padding: 12 }} onClick={onClick}>
      ...
      <Typography variant='body1' color='inherit'>
        This is a custom button and pop up making use of frameless-titlebar's theme context
      </Typography>
    </div>
  )
}
