...
import { useChildRefs, useWidth, usePrevious, useAccessibility } from '../effects'
...
const VerticalMenu = ({ menu, focused, currentWindow, onOpen, onButtonHover }: VerticalMenuProps) => {
  ...
  useAccessibility(fixedMenu, childRefs, selectedPath, dispatch, undefined, undefined, currentWindow)
